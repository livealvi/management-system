...
<?php
 if(isset($_POST['submit'])){
    ...
    $gender = $_POST['gender'];
    $blood = $_POST['blood'];
    $totalDonate = $_POST['totalDonate'];
    $donateDate = $_POST['donateDate'];


    $query = "INSERT INTO addDonor(name, address, age, gender, blood, totalDonate, donateDate) VALUES ('$donName', '$address', '$age', '$gender', '$blood', '$totalDonate', '$donateDate')";
    $run = mysqli_query($db, $query);

    if($run){
        $messageReg = "Donor Add Successful!";
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link active" href="adddon.php">Add Donor</a>
    ...
    <div class="float-center" style="padding-top:30px; padding-bottom: 30px; font-size: 30px;">
        <p class="text-center">Add Donor</p>
    </div>
    <div class="container">
        <div class="d-flex justify-content-center">
                <div class="form" style="width: 350px;">
                    <form action="" method="post">
                        ...
                        <!-- --- -->
                        <div class="form-group">
                            <label for="totalDonate">Total Donate / How Many Times</label>
                            <input class="form-control" type="text" name="totalDonate" placeholder="enter number" required>
                        </div>
                        <!-- --- -->
                        <!-- --- -->
                        <div class="form-group">
